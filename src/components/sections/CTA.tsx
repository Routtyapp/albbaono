...
const faqs = [
  ...
  {
    q: '어떤 AI 엔진을 지원하나요?',
    a: '현재 ChatGPT(GPT-4o-mini)와 Google Gemini(2.0 Flash)를 지원합니다. 각 엔진에 동일한 쿼리를 실행하고 브랜드 언급 여부, 인용 순위, 경쟁사 노출을 비교 분석합니다.',
  },
  {
    q: '무료로 사용할 수 있나요?',
    a: '네. 회원가입 후 브랜드 등록, 쿼리 테스트, 성과 대시보드, GEO 점수 분석, AI 인사이트까지 기본 기능을 무료로 이용할 수 있습니다.',
  },
  {
    q: '결과를 확인하기까지 얼마나 걸리나요?',
    a: '쿼리 등록 후 테스트 결과는 즉시 확인할 수 있습니다. GEO 점수 분석은 URL 입력 후 약 1분 내에 완료됩니다. 콘텐츠 개선 효과는 보통 1~2주 내에 측정됩니다.',
  },
  {
    q: 'GEO 점수는 어떻게 산출되나요?',
